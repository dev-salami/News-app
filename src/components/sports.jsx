      ...
      <section className="bg-red-200 py-20">
        <div class="flex justify-center">
          <nav aria-label="Page navigation example">
            <ul class="flex space-x-3 list-style-none">
              <li class="page-item" onClick={Fetchone}>
                <a
                  class={
                    One
              ...
              <li class="page-item active" onClick={Fetchtwo}>
                <a
                  class={
                    Two
                      ? "page-link relative block py-1.5 px-3 border-0 bg-blue-600 outline-none transition-all duration-300 rounded-full text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md"
              ...
              <li class="page-item" onClick={Fetchtre}>
                <a
                  class={
                    Three
                      ? "page-link relative block py-1.5 px-3 border-0 bg-blue-600 outline-none transition-all duration-300 rounded-full text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md"
              ...
              <li class="page-item" onClick={Fetchfor}>
                <a
                  class={
                    Four
                      ? "page-link relative block py-1.5 px-3 border-0 bg-blue-600 outline-none transition-all duration-300 rounded-full text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md"
              ...
              <li class="page-item" onClick={Fetchfive}>
                <a
                  class={
                    Five
                      ? "page-link relative block py-1.5 px-3 border-0 bg-blue-600 outline-none transition-all duration-300 rounded-full text-white hover:text-white hover:bg-blue-600 shadow-md focus:shadow-md"
